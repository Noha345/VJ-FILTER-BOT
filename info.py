...
API_ID = int(environ.get('API_ID', '28050588'))
API_HASH = environ.get('API_HASH', '6ef31a2c5276a936ce2d2e228fa90fc3')
BOT_TOKEN = environ.get('BOT_TOKEN', "8136148524:AAHd8Z0ZVa-W9CymuhukOrqKJPWD-I32C1s")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://graph.org/file/9ffff1ff8cbff844488fb-c7bc1749d6df285f00.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7593547594').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002436238206'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002170394849').split()]  # For Multiple Id Use One Space Between Each.
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002436238206')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://MangoMasala:Mango123@@cluster0.prx8r.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "MangoMasalabot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'MangoMasalacollection')
...
OWNER_LNK = environ.get('OWNER_LNK', 'http://t.me/MangoMasalabot')
